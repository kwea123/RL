...
class ArmEnvGraph(object):
    ...
    def _get_state(self):
        ...
        for y in range(self.point_info[1]//20 -1, self.point_info[1]//20 +1):
            for x in range(self.point_info[0]//20 -1, self.point_info[0]//20 +1):
                graph[y][x] = 1
        
        return np.ravel(graph), t_arms[-2:]
